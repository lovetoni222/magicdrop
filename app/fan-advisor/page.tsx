  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-black text-white">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-6 md:px-8 space-y-8">
        ...
        >
          Fans are the heartbeat of MagicDrop. We're inviting a select group of
          passionate community leaders and superfans to help shape the future of
          artist drops, products, and immersive storytelling experiences.
          Join our Fan Advisor Program and help co-create the next wave.
        </motion.p>
